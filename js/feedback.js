...
const FB_I18N = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { v: 'matching', l: 'التواصل مع المُعاد تدويرين' },
          { v: 'chatbot', l: 'روبوت المحادثة الذكي' },
          { v: 'dashboard', l: 'لوحة الإحصاءات' },
  ...
  wo: {
    ...
    prompt_yes: 'Waaw, mangi dem',
    prompt_no: 'Deedéet, nak',
    form_title: 'Yónnee sa xalaat',
    prev: 'Ginaaw',
    next: 'Kanam',
    submit: 'Yónnee',
    thankyou_title: 'Jërëjëf!',
    thankyou_text: 'Sa xalaat dafa dëkk. Dina nu wère ci yëgëlal RecapLink.',
    close: 'Tëj',
    step_of: (n, t) => `Laaj ${n} ci ${t}`,
    required_hint: 'Tëj ci laaj bii yëgël.',
    questions: [
      {
        key: 'satisfaction', type: 'stars',
        label: 'Lu jëm ci projet RecapLink bi?',
      },
      {
        key: 'profile', type: 'radio',
        label: 'Ana sa rôle ci teral plastique bi?',
        options: [
          { v: 'collector', l: 'Collecteur' },
          { v: 'recycler', l: 'Recycleur' },
      ...
      {
        key: 'features', type: 'multi',
        label: 'Luy ci bëgg ci application bi?',
        options: [
          { v: 'collection', l: 'Gérer collecte yi' },
          { v: 'matching', l: 'Xam recycleur yi' },
          { v: 'chatbot', l: 'Chatbot IA' },
          { v: 'dashboard', l: 'Xam-xam yi' },
          { v: 'badges', l: 'Badge yi' },
        ],
      },
      {
        ...
        options: [
          ...
          { v: 'unsure', l: 'Soxor la' },
          { v: 'probably_no', l: 'Déedéet, reen reen' },
      ...
      },
      {
        ...
        options: [
          ...
          { v: 'internet', l: 'Yëgël internet' },
          { v: 'other', l: 'Yenn' },
        ],
      },
      {
        key: 'comment', type: 'textarea',
        label: 'Am nga yenn xalaat walla sàggal?',
